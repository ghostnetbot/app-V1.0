...
class MediaPickerViewController: UIViewController {
    ...
    @IBOutlet weak var userNameCard: UILabel!
    @IBOutlet weak var storyViewsCard: UILabel!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        userNameCard.text = userNames[myIndex]
        storyViewsCard.text = storyViews[myIndex]
        userImage.image = UIImage(named: userNames[myIndex] + ".jpg")
